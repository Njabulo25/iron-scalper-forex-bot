...
print("=" * 70)
print("LONDON BREAKOUT - BACKTEST")
print("=" * 70)
...
for trade in trades:
    ...
    print(f"{status} | {trade['time']} | {trade['type']} | Entry: {entry_price:.2f} | SL: {sl:.2f} | TP: {tp:.2f} | Exit: {exit_price:.2f} | Pips: {profit_pips:+.1f} | Bars: {bars_held}")
